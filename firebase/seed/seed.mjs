...
const projects = [
  {
    ...
    clientId: "acme",
    name: "Client Project — Video",
    description: "A 90-second promotional video for a product launch.",
    status: "active",
    stage: "qa",
...
const activity = [
  ...
  },
  {
    ...
    clientName: "Acme Corp",
    projectId: "acme-brand-film",
    projectName: "Client Project — Video",
    deliverableId: "film-cut-v3",
    deliverableName: "Video Cut — v3",
    actorName: "Studio Admin",
    actorRole: "admin",
    summary: "Published “Video Cut — v3” to Client Project — Video",
    createdAt: iso(-6),
  },
  {
    id: "a3",
    ...
    clientName: "Acme Corp",
    projectId: "acme-website",
    projectName: "Client Project — Website",
    deliverableId: "web-design-review",
